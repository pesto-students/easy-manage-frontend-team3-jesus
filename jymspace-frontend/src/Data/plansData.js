      ...
      >
        <g>
          <g>
            <g>
              <path
                d="M244.459,221.397c2.859,0,5.547-1.088,7.552-3.115c4.16-4.16,4.16-10.923,0-15.104l-7.552-7.552l-15.104,15.104
                  l7.552,7.531C238.933,220.288,241.6,221.397,244.459,221.397z"
              />
              <path
                d="M510.592,238.507c-2.069-15.979-6.635-30.464-13.355-43.605c-0.064-0.128-0.149-0.235-0.213-0.363
              ...
              />
              <path
                d="M437.675,231.595c-29.888-4.864-70.827-11.499-108.288-48.96c-37.461-37.461-44.096-78.4-48.96-108.288
  ...
  },
  {
    icon: (
      ...
      >
        <g>
          <path
            d="M148.5,190.718c9.881,0,17.918-8.038,17.918-17.919c0-9.88-8.037-17.918-17.918-17.918
          c-9.881,0-17.918,8.038-17.918,17.918C130.582,182.68,138.619,190.718,148.5,190.718z"
          />
          <path
            d="M297,107.999c0-9.881-8.038-17.918-17.918-17.918c-9.881,0-17.919,8.037-17.919,17.918c0,3.205,0.856,6.209,2.337,8.815
    ...
    price: "20",
    features: [
      "For large studios looking for scaling their business",
      "Up to 25 Employees",
      "Unlimited Members",
    ],
  },
  {
    icon: (
      <svg
        ...
        x="0px"
        y="0px"
        viewBox="0 0 388.297 388.297"
        xmlSpace="preserve"
      >
        <g>
          <rect x="0" y="134.514" width="64.902" height="119.269" />
          <polygon
            points="243.936,178.815 144.359,178.815 144.359,104.148 79.456,104.148 79.456,284.148 144.359,284.148 144.359,209.481 
    ...
    price: "12",
    features: [
      "For Medium gyms looking to optimize management",
      "10 Employees",
      "250 Members",
    ],
  },
